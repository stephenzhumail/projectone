...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.window.rootViewController = [[WTTableViewController alloc]initWithStyle:UITableViewStyleGrouped];
...
{
    self.window.rootViewController = [[UIWebViewController alloc]init:name];
}
